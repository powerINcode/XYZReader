...
public class ArticleDetailFragment2 extends Fragment implements
    ...
    private static final String TAG = "ArticleDetailFragment2";
...
//                getActivityCast().onUpButtonFloorChanged(mItemId, ArticleDetailFragment2.this);
...
//        mDrawInsetsFrameLayout.setInsetBackground(mStatusBarColorDrawable);
    ...
    private void bindViews() {
        ...
        ImageView imageView = mRootView.findViewById(R.id.iv_photo);
        TextView taleDescriptionView = (TextView) mRootView.findViewById(R.id.tv_tale_description);
        TextView bodyView = (TextView) mRootView.findViewById(R.id.tv_body);
        String date;
...
//        bodyView.setTypeface(Typeface.createFromAsset(getResources().getAssets(), "Rosario-Regular.ttf"));
        ...
        if (mCursor != null) {
            ...
            taleDescriptionView.setText("N/A" );
